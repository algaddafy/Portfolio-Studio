        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">This is all about my lectures.</h3>
                </div>
                <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="portfolio-item">
                                    <div class="portfolio-link" data-toggle="modal">
                                        <img class="img-fluid" src="{{url('uploads/main/'.$portfolio->small_image)}}" alt="" />
                                    </div>
                                    <div class="portfolio-caption">
                                        ...
                                        <div class="portfolio-caption-subheading ">{{$portfolio->description}}</div>
                                        {{-- <div class="portfolio-caption-subheading ">{{Str::limit(strip_tags($portfolio->description),40)}}</div> --}}
                                    </div>
                                </div>
                            </div>
                        @endforeach
